...
function SearchBar(){
    ...
    async function search(e){
        ...
        try {
            let response = await axios.post('http://localhost:8080/api/getlist', searchResult)
    ...
    return (
        ...
        <Container style={{backgroundColor: '#F2F2F2', borderRadius: '10px'}}>
            <Row>
                ...
                <Label>City</Label>
                <Input onChange={getLocation} type="text" placeholder="Search by City" style={{ backgroundColor: '#E0E0E0', borderRadius: '5px'}} />
                <i style={{position: 'absolute', top: '67px', right: '30px'}} className="fas fa-map-marker-alt"></i>
                </Col>
                <Col md='3' className={styles.column}>
                ...
                <Label>Host</Label>
                <Input onChange={getName} type="text" placeholder="Search by Host Name" style={{backgroundColor: '#E0E0E0', borderRadius: '5px'}} />
                </Col>
